...
- [x] Localization
  - [x] Docs will be structured like: `/<category>/<pagename.md>` or
        `/<category>/<pagename>/(en/es/etc).md`
        allowing docs to be done by default in `en` but if a translator comes they the
        file can be moved to a folder to support multiple translations
